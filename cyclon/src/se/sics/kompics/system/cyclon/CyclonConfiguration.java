...
//-------------------------------------------------------------------	
	public CyclonConfiguration(int shuffleLength, int viewSize, long shufflePeriod, long shuffleTimeout, BigInteger identifierSpaceSize, int bootstrapRequestPeerCount) {
		super();
...
//-------------------------------------------------------------------	
	public void store(String file) throws IOException {
		...
		p.store(writer, "se.sics.kompics.system.cyclon");
	}
...
//-------------------------------------------------------------------	
	public static CyclonConfiguration load(String file) throws IOException {
		...
		return new CyclonConfiguration(shuffleLength, viewSize, shufflePeriod, shuffleTimeout, identifierSpaceSize, bootstrapRequestPeerCount);
	}
}
